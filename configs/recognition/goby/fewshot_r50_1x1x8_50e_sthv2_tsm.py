...
optimizer_backbone_training = dict(
    type='SGD', constructor='TSMOptimizerConstructor',paramwise_cfg=dict(fc_lr5=True), 
    lr=[0.0001,0.001], momentum=0.9,
    weight_decay=0.0005)  
...
log_level = 'INFO'
work_dir = './work_dirs/fewshot_tsm_retrain_12epoch/'
# load_from = None
load_from = './work_dirs/fewshot_tsm/epoch_12.pth'
resume_from = None
workflow = [('train', 1)]
